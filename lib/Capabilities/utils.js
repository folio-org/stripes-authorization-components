...
export const getResultsFormatter = ({ renderItemActionCheckbox, capabilitiesToCompare, isNeedToCompare }) => ({
  [CAPABILITIES_COLUMN_NAMES.application]: (item) => isUniqueField(
    ...
    CAPABILITIES_COLUMN_NAMES.applicationId,
    item.applicationId,
    isNeedToCompare,
  ),
...
export const getColumnMappingWithWrapper = (formatMessage, wrapper) => ({
  [CAPABILITIES_COLUMN_NAMES.application]: formatMessage(columnTranslations.application),
  [CAPABILITIES_COLUMN_NAMES.resource]: formatMessage(columnTranslations.resource),
  [CAPABILITIES_COLUMN_NAMES.view]: wrapper(CAPABILITIES_COLUMN_NAMES.view),
  [CAPABILITIES_COLUMN_NAMES.edit]: wrapper(CAPABILITIES_COLUMN_NAMES.edit),
  [CAPABILITIES_COLUMN_NAMES.create]: wrapper(CAPABILITIES_COLUMN_NAMES.create),
  [CAPABILITIES_COLUMN_NAMES.delete]: wrapper(CAPABILITIES_COLUMN_NAMES.delete),
  [CAPABILITIES_COLUMN_NAMES.manage]: wrapper(CAPABILITIES_COLUMN_NAMES.manage),
  [CAPABILITIES_COLUMN_NAMES.execute]: wrapper(CAPABILITIES_COLUMN_NAMES.execute),
});
