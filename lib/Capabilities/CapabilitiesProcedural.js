...
const CapabilitiesProcedural = ({
  ...
  const resultsFormatter = useMemo(() => ({
    application: item => isUniqueField(capabilitiesToCompare, 'applicationId', getApplicationName(item.applicationId), isNeedToCompare),
    resource: item => isUniqueField(capabilitiesToCompare, 'resource', item.resource, isNeedToCompare),
