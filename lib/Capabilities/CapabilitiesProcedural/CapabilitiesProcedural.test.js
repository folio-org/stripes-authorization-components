...
describe('Procedural capabilities type', () => {
  ...
  it('renders fields in the grid', () => {
    ...
    expect(screen.getByText(proceduralTypeCapabilities[0].resource)).toBeInTheDocument();
    expect(screen.getByText(proceduralTypeCapabilities[0].applicationId)).toBeInTheDocument();
  });
