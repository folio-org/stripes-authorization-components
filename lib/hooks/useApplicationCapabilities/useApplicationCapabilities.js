...
export const useApplicationCapabilities = ({
  ...
  // 'checked' form state needs to come directly from persisted data,
  // or from direct form interaction with the affected checkboxes.
  // not the client-filtered view, so we don't use the `filteredCapabilities` here.
