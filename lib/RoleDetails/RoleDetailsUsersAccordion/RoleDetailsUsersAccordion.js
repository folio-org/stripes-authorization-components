...
export const RoleDetailsUsersAccordion = ({ isUserLinkEnabled, roleId, tenantId }) => {
  ...
  const usersData = sortedUsers.map(i => {
    const fullName = isUserLinkEnabled ? (<LinkedUser user={i} />) : getFullName(i);
...
RoleDetailsUsersAccordion.propTypes = {
  isUserLinkEnabled: PropTypes.string.isRequired,
