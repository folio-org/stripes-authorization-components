...
export const RoleDetailsUsersAccordion = ({ isClickable, roleId, tenantId }) => {
  ...
  const usersData = sortedUsers.map(i => {
    const fullName = isClickable ? (<LinkedUser user={i} />) : getFullName(i);
...
RoleDetailsUsersAccordion.propTypes = {
  isClickable: PropTypes.string.isRequired,
