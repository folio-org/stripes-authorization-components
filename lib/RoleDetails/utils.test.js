import {
  ...
  apiVerbs,
  checkAndGetNoneKeycloakAuthUsers
} from './utils';
...
describe('RoleDetails utils', () => {
  ...
  describe('checkAndGetNoneKeycloakAuthUsers', () => {
    it('should return an empty array when all users exist in Keycloak', async () => {
      ...
      const result = await checkAndGetNoneKeycloakAuthUsers({ roleId: 'role1', userIds, queryClient, ky });
    ...
    it('should return user IDs that do not exist in Keycloak', async () => {
      ...
      const result = await checkAndGetNoneKeycloakAuthUsers({ roleId: 1, userIds, queryClient, ky });
