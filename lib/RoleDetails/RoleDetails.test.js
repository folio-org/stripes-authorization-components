...
describe('RoleDetails component', () => {
  ...
  describe('renders roles details pane with expanded information', () => {
    ...
    describe('when the role being deleted is assigned to the current user', () => {
      ...
      it('shows an additional warning instead of deleting the role right away', async () => {
        const { getByRole } = renderComponent();
      ...
      it('deletes the role once the warning is confirmed', async () => {
        const { getByRole } = renderComponent();
      ...
      it('does not delete the role when the warning is cancelled', async () => {
        const { getByRole } = renderComponent();
