...
describe('useCheckboxHandlers', () => {
  ...
  describe('getUnselectedItemCounts', () => {
    it('returns 0 when no items match unselected app ids', () => {
      ...
      expect(getUnselectedItemCounts(unselectedAppIds, items, checkedMap)).toStrictEqual({ unselectedCapabilitySetCount: 0, unselectedCapabilityCount: 0 });
    });
    ...
    it('counts only checked items with matching applicationId', () => {
      ...
      expect(getUnselectedItemCounts(unselectedAppIds, items, checkedMap)).toStrictEqual({ unselectedCapabilitySetCount: 0, unselectedCapabilityCount: 3 });
    });

    it('counts capability sets and their child capabilities', () => {
      const unselectedAppIds = ['1'];
      const items = {
        groupA: [
          { id: 'set1', applicationId: 'app-1', capabilities: ['cap1', 'cap2', 'cap3'] },
          { id: 'cap4', applicationId: 'app-1' },
        ],
      };
      const checkedMap = { set1: true, cap4: true };
      expect(getUnselectedItemCounts(unselectedAppIds, items, checkedMap)).toStrictEqual({ unselectedCapabilitySetCount: 1, unselectedCapabilityCount: 4 });
    });
    ...
    it('handles multiple groups with capability sets and capabilities', () => {
      const unselectedAppIds = ['1', '2'];
      const items = {
        groupA: [
          { id: 'set1', applicationId: 'app-1', capabilities: ['cap1', 'cap2'] },
          { id: 'cap3', applicationId: 'app-2' },
        ],
        groupB: [
          { id: 'set2', applicationId: 'app-2', capabilities: ['cap4', 'cap5', 'cap6'] },
          { id: 'cap7', applicationId: 'app-3' },
        ],
      };
      const checkedMap = { set1: true, cap3: true, set2: true, cap7: true };
      expect(getUnselectedItemCounts(unselectedAppIds, items, checkedMap)).toStrictEqual({ unselectedCapabilitySetCount: 2, unselectedCapabilityCount: 6 });
    });

    it('ignores capability sets with empty capabilities array', () => {
      const unselectedAppIds = ['1'];
      const items = {
        groupA: [
          { id: 'set1', applicationId: 'app-1', capabilities: [] },
          { id: 'cap1', applicationId: 'app-1' },
        ],
      };
      const checkedMap = { set1: true, cap1: true };
      expect(getUnselectedItemCounts(unselectedAppIds, items, checkedMap)).toStrictEqual({ unselectedCapabilitySetCount: 1, unselectedCapabilityCount: 1 });
    });

    it('handles mixed checked and unchecked items in multiple groups', () => {
      const unselectedAppIds = ['1', '2'];
      const items = {
        groupA: [
          { id: 'set1', applicationId: 'app-1', capabilities: ['cap1'] },
          { id: 'cap2', applicationId: 'app-2' },
        ],
        groupB: [
          { id: 'set2', applicationId: 'app-2', capabilities: ['cap3', 'cap4'] },
          { id: 'cap5', applicationId: 'app-1' },
        ],
      };
      const checkedMap = { set1: true, cap2: false, set2: true, cap5: true };
      expect(getUnselectedItemCounts(unselectedAppIds, items, checkedMap)).toStrictEqual({ unselectedCapabilitySetCount: 2, unselectedCapabilityCount: 4 });
    });
  });
