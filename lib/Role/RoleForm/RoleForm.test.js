...
import { mockPluggableOnClose, Pluggable } from '@folio/stripes/core';
...
describe('RoleForm', () => {
  ...
  it('wires the application pluggable trigger and unassign-all action', async () => {
    ...
    expect(Pluggable.mock.calls[0][0]).toEqual(
      expect.objectContaining({ assignedAppIdsMap: defaultProps.assignedAppIdsMap }),
    );
