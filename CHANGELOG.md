...
* [UISAUTHCOM-78](https://folio-org.atlassian.net/browse/UISAUTHCOM-78) Add timeout to useOkapiKy in useDeleteRoleMutation to 60 seconds to match the value in Kong and fix timeout issue.
